# Webster & Phillips (2024) - Four epiallele model, tracks A_M, A_U, a_M, a_U over generations with mutation and epimutation
Theory_WP <- function(N = 100, generations = 50, mu = 1e-5, rho = 1e-3, initial_freqs = c(A_M = 0.10, A_U = 0.40, a_M = 0.10, a_U = 0.40)) {
